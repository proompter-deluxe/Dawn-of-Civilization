...
# The Vikings now spawn at Oslo instead of Nidaros/Trondheim. This was to make them more involved into European politics (not sure if that worked), and to help them with city placement, especially in southern Scandinavia. And there really is a Stockholm, Kalmar or G�teborg more often (still no Viking Copenhagen, though).
...
# Turkey: added Mustafa Kemal Atat�rk to represent modern Turkey. Thus: Mehmed -> Suleiman -> Atat�rk
...
# Ekmek (Akbar, Meiji, Dido/Elishat, Atat�rk leaderheads)
...
I hope you enjoy RFC Dawn of Civilization Cross Overhaul :)