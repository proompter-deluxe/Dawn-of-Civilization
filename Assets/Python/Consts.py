...
iTurks, iVietnam, iYangtzeChina, iZulu, iIndependent, iIndependent2, iNative, iMinor, iBarbarian) = tuple(Civ(i) for i in range(iNumCivs))
...
iCivGroupAsia : [iIndia, iChina, iYangtzeChina, iHarappa, iPolynesia, iPersia, iJapan, iDravidia, iKushans, iKorea, iKhmer, iMalays, iJava, iTibet, iBurma, iVietnam, iMongols, iMughals, iThailand, iRussia, iTurks],
iCivGroupMiddleEast : [iEgypt, iBabylonia, iAssyria, iHittites, iPersia, iKushans, iByzantium, iArabia, iMoors, iSwahili, iOttomans, iPhoenicia, iTurks, iIran],
...
iCivGroupAfrica : [iEgypt, iNubia, iPhoenicia, iEthiopia, iMali, iMoors, iSwahili, iCongo],
...
iTechGroupMiddleEast : [iEgypt, iBabylonia, iHarappa, iAssyria, iHittites, iNubia, iIndia, iPhoenicia, iPersia, iEthiopia, iKushans, iMali, iArabia, iMoors, iSwahili, iOttomans, iMughals, iDravidia, iCongo, iTurks, iIran],
iTechGroupFarEast : [iChina, iYangtzeChina, iKorea, iKhmer, iMalays, iJapan, iJava, iTibet, iBurma, iVietnam, iMongols, iThailand],
...
lNeighbours = [
	...
	(iChina, iTibet),
	(iChina, iMongols),
	(iYangtzeChina, iVietnam),
	(iYangtzeChina, iJapan),
	(iYangtzeChina, iKorea),
	(iYangtzeChina, iTibet),
	(iYangtzeChina, iBurma),
	(iYangtzeChina, iMongols),
	(iHittites, iGreece),
...
iAssyria : [(-3000, -600)],
iChina : [(580, 2020)],
iYangtzeChina : [(910, 1660), (1850,1920)],
iHittites : [(-1800, -800)],
iNubia : [(500, 1500)],
iGreece : [(1800, 2020)],
