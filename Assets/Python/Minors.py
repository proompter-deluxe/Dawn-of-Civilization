...
minor_cities = [
	...
	MinorCity(-1600, iIndependent, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iBabylonia, units={iDefend: 3}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	...
	MinorCity(-700, iIndependent2, tKerasous, "Kerasous", iPopulation=2, iCiv=iGreece, units={iDefend: 1}, condition=lambda: player(iGreece).isExisting() and not player(iGreece).isHuman(),  adjective="TXT_KEY_CIV_GREECE_ADJECTIVE"),
...
barbarians = [
	...
	Barbarians(-1250, -1150, {iVulture: 2}, ((90, 47), (93, 51)), 7, INVADERS, adjective="TXT_KEY_ADJECTIVE_KASSITE"),
	...
	Barbarians(550, 650, {iHorseArcher: 4, iSwordsman: 2}, ((70, 57), (80, 62)), 4, INVADERS, target_area=((65, 52), (72, 59)), adjective="TXT_KEY_ADJECTIVE_AVAR", promotions=(iMobility,)),
	...
	Barbarians(600, 650, {iKonnik: 3}, ((78, 57), (82, 61)), 2, INVADERS, target_area=((74, 52), (79, 56)), iAlternativeCiv=iBulgaria, adjective="TXT_KEY_ADJECTIVE_BULGAR", promotions=(iMobility,)),
