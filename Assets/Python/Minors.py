...
minor_cities = [
	...
	MinorCity(-1200, iIndependent2, (80, 52), "Sfard", iPopulation=2, iCiv=iGreece, units={iDefend: 2}, condition=lambda: not player(iHittites).isExisting(), adjective="TXT_KEY_ADJECTIVE_LYDIAN"),
...
barbarians = [
	...
	Barbarians(-1100, -600, {iLightSwordsman: 1, iAxeman: 1, iSpearman: 1}, ((79, 51), (84, 55)), 5, MINORS, adjective="TXT_KEY_ADJECTIVE_PHRYGIAN"),
	...
	Barbarians(1050, 1110, {iCamelArcher: 3, iHeavySwordsman: 3}, ((56, 39), (58, 49)), 1, CLOSE_INVADERS, target_area=((56, 44), (58, 49)), adjective="TXT_KEY_ADJECTIVE_ALMORAVID", promotions=(iDesertAdaptation,)),
