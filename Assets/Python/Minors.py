...
minor_cities = [
	...
	MinorCity(-2050, iBarbarian, (118, 49), "Sanxingdui", iPopulation=1, iCiv=iChina, units={iDefend: 1, iBase: 1}, adjective="TXT_KEY_ADJECTIVE_SHU"),
	...
	MinorCity(-300, iBarbarian, (57, 52), "Vaccaei", iPopulation=2, iCiv=iCelts, units={iDefend: 1, iHarass: 1}, adjective="TXT_KEY_ADJECTIVE_CELTIC"),
