...
class TestDescription(ExtendedTestCase):
	...
	def test_multiple_goals(self):
		requirements = [(BuildingCount(iGranary, 3), BuildingCount.GOAL_DESC_KEY, [], [], None), (ResourceCount(iSilk, 4), ResourceCount.GOAL_DESC_KEY, [], [], None)]
	...
	def test_multiple_goals_different_suffixes(self):
		requirements = [(BuildingCount(iGranary, 3), BuildingCount.GOAL_DESC_KEY, [], ["by 1000 AD"], None), (ResourceCount(iSilk, 4), ResourceCount.GOAL_DESC_KEY, [], ["in 1500 AD"], None)]
	...
	def test_multiple_goals_shared_arguments(self):
		requirements = [(BestCultureCity(LocationCityArgument((61, 31)).named("Test City")), BestCultureCity.GOAL_DESC_KEY, [], [], None), (BestPopulationCity(LocationCityArgument((61, 31)).named("Test City")), BestPopulationCity.GOAL_DESC_KEY, [], [], None)]
	...
	def test_multiple_goals_different_arguments(self):
		requirements = [(BestCultureCity(LocationCityArgument((61, 31)).named("First City")), BestCultureCity.GOAL_DESC_KEY, [], [], None), (BestPopulationCity(LocationCityArgument((63, 31)).named("Second City")), BestPopulationCity.GOAL_DESC_KEY, [], [], None)]
	...
	def test_multiple_goals_different_desc_keys(self):
		requirements = [(BestCultureCity(LocationCityArgument((61, 31)).named("Test City")), "TXT_KEY_VICTORY_DESC_HAVE", [], [], None), (BestPopulationCity(LocationCityArgument((61, 31)).named("Test City")), "TXT_KEY_VICTORY_DESC_ACQUIRE", [], [], None)]
	...
	def test_multiple_goals_different_suffixes(self):
		requirements = [(BestCultureCity(LocationCityArgument((61, 31)).named("Test City")), BestCultureCity.GOAL_DESC_KEY, [], ["by 1000 AD"], None), (BestPopulationCity(LocationCityArgument((61, 31)).named("Test City")), BestPopulationCity.GOAL_DESC_KEY, [], ["in 1500 AD"], None)]
